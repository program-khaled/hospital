...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">التقرير الطبي للمريض</h1>
</div>
<ol class="breadcrumb">
<li>
<span>الدكتور</span>
...
اضافة معلومات حول المريض</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">اضافة معلومات حول المريض</h5>
  ...
  <tr>
    ...
    <th>العلاج :</th>
    <td>
    <textarea name="pres" placeholder="اكتب وصفة طبية للمريض" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>  
