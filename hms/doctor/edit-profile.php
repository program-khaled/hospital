...
if($sql)
{
echo "<script>alert('تم تحديث تفاصيل الطبيب بنجاح');</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">تحرير الحساب</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">تحرير حسابك</h5>
												</div>
...
{
?>
<h4><?php echo htmlentities($data['doctorName']);?></h4>
