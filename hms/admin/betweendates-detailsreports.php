...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">جميع تقارير المرضى</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h4 class="tittle-w3-agileits mb-4">سجلات المرضى حسب التاريخ</h4>
<?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];

?>
<h5 align="center" style="color:blue">تقرير من <?php echo $fdate?>  الى <?php echo $tdate?></h5>
