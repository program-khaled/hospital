				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">جميع الاستشارات التي تم قرائتها</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
?>
							...
							<a href="query-details.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-lg" title="شاهد التفاصيل كاملة"><i class="fa fa-file"></i></a>
												</div>
